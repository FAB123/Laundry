...
<?php echo form_open('#', array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	...
	<div class="form-group form-group-sm">
		<?php echo form_label($this->lang->line('sales_serial'), 'reports_serial_label', array('class'=>'required control-label col-xs-2')); ?>
...
$(document).ready(function()
{
	...
	{
		window.location = [window.location, start_date, end_date, $("#filters").val().join(':') || 0, $("#serial").val() || 0].join("/");
	});
});
