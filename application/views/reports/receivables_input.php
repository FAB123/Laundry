...
<?php echo form_open('#', array('id'=>'item_form', autocomplete=>"off", 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	<div class="form-group form-group-sm">
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('reports_customers'), 'reports_customers_label', array('class'=>'required control-label col-xs-2')); ?>
			<div class="col-xs-3">
				<?php echo form_multiselect('filters[]', $specific_customer_data, '', array('id'=>'filters', 'class'=>'form-control selectpicker', 'data-live-search'=>'true', 'data-none-selected-text'=>$this->lang->line('common_none_selected_text'), 'data-selected-text-format'=>'count > 1')); ?>
			</div>
		</div>
