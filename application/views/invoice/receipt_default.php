...
<div id="receipt_wrapper" style="font-size:<?php echo $this->config->item('receipt_font_size');?>px">
	...
	<div id="receipt_general_info">
		...
		<div id="sale_id"><?php echo $this->lang->line('sales_id_nums').": ".$sale_id; ?></div>
	...
	<table id="receipt_items">
		<tr>
			<th style="width:40%;text-align:center"><?php echo $this->lang->line('sales_description_abbrv'); ?></th>
			<th style="width:20%;text-align:right"><?php echo $this->lang->line('sales_quantity'); ?></th>
			<th style="width:20%;text-align:right"><?php echo $this->lang->line('sales_price'); ?></th>
			<th style="width:20%;text-align:right" class="total-value"><?php echo $this->lang->line('sales_total'); ?></th>
		</tr>
		<?php
