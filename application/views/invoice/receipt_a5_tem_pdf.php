...
$this->load->library('Inva5dot');
$this->load->library('En');
$this->load->library('Ar');
$con = new convert();
$Money=new Currency();
$pdf = new PDF_Invoicea5dot( 'P', 'mm', 'A5', true, 'UTF-8', false);
...
//$pdf->addCompany_ar( $this->config->item('company_ar'), $this->config->item('address_ar'), $this->config->item('phone'));		
}
else
{
...
//$pdf->addCompany( $this->config->item('company'), $this->config->item('address'), $this->config->item('phone'));	
