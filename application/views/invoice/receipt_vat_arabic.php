...
<div id="receipt_wrapper" style="font-size:<?php echo $this->config->item('receipt_font_size');?>px">
	...
	<div id="receipt_general_info">
		...
		{
		?>
			<div id="customer"><?php echo $this->lang->line('customers_customer_ar').": ".$customer; ?></div>
		<?php
		}
		?>
		...
		<div id="employee"><?php echo $this->lang->line('employees_employee_ar').": ".$employee; ?></div>
	</div>

	<table id="receipt_items">
		<tr>
			<th style="width:30%;"><?php echo $this->lang->line('sales_description_abbrv_ar'); ?></th>
			<th style="width:10%;"><?php echo $this->lang->line('sales_qty_ar'); ?></th>
			<th style="width:20%;"><?php echo $this->lang->line('sales_price_ar'); ?></th>
			<th style="width:20%;"><?php echo $this->lang->line('sales_sub_total_ar'); ?></th>
			<th style="width:20%;"><?php echo $this->lang->line('sales_vat_ar'); ?></th>
			<th style="width:30%;"><?php echo $this->lang->line('sales_total_ar'); ?></th>
		</tr>
		<?php
		...
		<tr>
			...
			<td colspan="2" style="text-align:right;"><?php echo $this->lang->line('sales_round_off_ar'); ?> </td>
			<td colspan="3" style="text-align:right;"><?php echo to_currency($rounded_due - $total); ?></td>
		</tr>
		
    	<tr>
		    <td colspan="2" style="text-align:right;"> </td>
			<td colspan="2" style="text-align:right;font-weight: bold;"><?php echo $this->lang->line('sales_net_amount_ar'); ?> </td>
