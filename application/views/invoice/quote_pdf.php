...
$pdf->write1DBarcode($quote_number, 'C128A', '', '', '', 17, 0.417, $style, 'N');

$pdf->SetFont('aefurat', '', 18);
$pdf->addCustomer($this->lang->line('customers_customer') , $customer, $customer_vatno, $this->lang->line('sales_id'), $quote_number, $this->lang->line('employees_employee'), $employee);
$pdf->adddates( $hdate, $transaction_time , $this->lang->line('sales_quote'));
    $order = 0;
...
$pdf->addpolicy($this->config->item('quote_default_comments'), $this->config->item('quote_default_comments_ar'));
$pdf->Output('Quote.pdf', 'F');
$this->sale_lib->clear_all();
?>
<table align="center">
  <object height=1200px width=900px type="application/pdf" data="<?php echo base_url("Quote.pdf?#zoom=100&scrollbar=0&toolbar=1&navpanes=1");?>" id="pdf_content">
  </object>
</table>