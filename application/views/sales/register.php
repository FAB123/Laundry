...
function getCost(elmnt,line) {
   $("#cost_item_button_"+line).toggle()
    ...
    <div class="row">
        ...
        <div id="sales_cart" class="col-md-9">
			<?php echo form_open($controller_name."/change_mode", array('id'=>'mode_form', 'class'=>'form-horizontal panel panel-default')); ?>
				<div class="panel-body form-group">
					<ul>
						...
						<li class="pull-left">
							<?php echo form_dropdown('mode', $modes, $mode, array('onchange'=>"$('#mode_form').submit();", 'class'=>'nav-link dropdown-toggle', data-toggle=>'dropdown' , 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit')); ?>
						</li>
						<?php
						...
						?>
							...
							<li class="pull-left">
								<?php echo form_dropdown('dinner_table', $empty_tables, $selected_table, array('onchange'=>"$('#mode_form').submit();", 'class'=>'nav-link dropdown-toggle', data-toggle=>'dropdown', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit')); ?>
							</li>
						<?php
						}
						...
						?>
							...
							<li class="pull-left">
								<?php echo form_dropdown('stock_location', $stock_locations, $stock_location, array('onchange'=>"$('#mode_form').submit();", 'class'=>'nav-link dropdown-toggle', data-toggle=>'dropdown', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit')); ?>
							</li>
						<?php
						}
						?>
						...
						<div class="btn-group pull-right">
							...
							<button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Menu
					...
					<table class="table table-bordered" id="register">
						<thead>
							<tr>
								...
								<th style="width: 15%;" class="mobile-style"><?php echo $this->lang->line('sales_item_number'); ?></th>
								<th style="width: 30%;"><?php echo $this->lang->line('sales_item_name'); ?></th>
								<th style="width: 10%;"><?php echo $this->lang->line('sales_price'); ?></th>
								<th style="width: 10%;" class="mobile-style"><?php echo $this->lang->line('sales_quantity'); ?></th>
								<th style="width: 10%;" class="desk-style"><?php echo $this->lang->line('sales_qty'); ?></th>
								<th style="width: 5%;" class="mobile-style"><?php echo $this->lang->line('items_qty_type'); ?></th>
							...
							?>
									...
									<?php echo form_open($controller_name."/edit_item/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
										<tr>
											...
											{
											?>
											<td class="mobile-style"><?php echo $item['item_number']; ?></td>
											
											<td class="desk-style" style="align: center;">
												<?php echo $item['name']; ?>
											</td>
											
											<td class="mobile-style" onclick="getCost(this, '<?php echo $line; ?>')" style="align: center;">
											...
											{
											?>
												<td><?php echo form_input(array('name'=>'price', 'class'=>'form-control input-sm tab'.$tabindex, 'value'=>to_currency_no_money($item['price']), 'tabindex'=>++$tabindex, 'onClick'=>'this.select();'));?></td>
											<?php
											}
											else
											{
											...
											<td>
												...
												{
													echo form_input(array('name'=>'quantity', 'class'=>'form-control input-sm tab'.$tabindex, 'value'=>to_quantity_decimals($item['quantity']), 'tabindex'=>++$tabindex, 'onClick'=>'this.select();'));
												}
												?>
											</td>
											
											<td class="mobile-style">
        ...
        <div  id="overall_sales" class="panel panel-default col-md-3">
								...
								<?php echo form_open($controller_name."/add_payment", array('id'=>'add_payment_form', 'class'=>'form-horizontal')); ?>
									<table class="sales_table_100">
										<tr>
											...
											<td>
												<?php echo form_dropdown('payment_type', $payment_options, $selected_payment_type, array('id'=>'payment_types', 'class'=>'nav-link dropdown-toggle', data-toggle=>'dropdown', 'data-style'=>'btn-default btn-sm', 'data-width'=>'auto', 'disabled'=>'disabled')); ?>
											</td>
										</tr>
										<tr>
								...
								<?php echo form_open($controller_name."/add_payment", array('id'=>'add_payment_form', 'class'=>'form-horizontal')); ?>
									<table class="sales_table_100">
										<tr>
											<td><?php echo $this->lang->line('sales_payment');?></td>
											<td>
												<?php echo form_dropdown('payment_type', $payment_options,  $selected_payment_type, array('id'=>'payment_types', 'class'=>'nav-link dropdown-toggle', data-toggle=>'dropdown', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit')); ?>
											</td>
										</tr>
										<tr>
											<td><span id="amount_tendered_label"><?php echo $this->lang->line('sales_amount_tendered'); ?></span></td>
...
$(document).ready(function()
{
	...
	{
		source: "<?php echo site_url("customers/customer_suggest"); ?>",
		minChars: 0,
		delay: 10,
		select: function (a, ui) {
			$(this).val(ui.item.value);
	...
	$("#sales_print_as_pdf").change(function()
	{
		$.post("<?php echo site_url($controller_name."/set_sales_print_as_pdf");?>", {print_as_pdf: $(this).is(":checked")});
	});
