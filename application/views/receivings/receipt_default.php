...
<div id="receipt_wrapper">
	...
	<table id="receipt_items">
		...
		<tr>
			...
			<td style='border-top:2px solid #000000;'><div class="total-value"><?php echo to_currency($subtotal); ?></div></td>
		</tr>
			<?php
		...
		<tr>
				<td colspan="3" class="total-value"><?php echo $this->lang->line('sales_total'); ?>:</td>
