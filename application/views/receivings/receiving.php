		...
		?>
			<table class="sales_table_100">
				<tr>
					...
					<?php
					if(!empty($supplier_account_balance))
					{
					?>
						<tr>
							<th style='width: 55%;'><?php echo $this->lang->line("sales_customer_balance"); ?></th>
							<th style="width: 45%; text-align: right;"><?php echo anchor('accounts/manage/1/'.$supplier_id, to_currency($supplier_account_balance)); ?></th>
						</tr>
					<?php
					}
					?>
