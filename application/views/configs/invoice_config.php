<?php echo form_open('config/save_invoice/', array('id' => 'invoice_config_form', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_quote_template'), 'quote_template', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_dropdown('quote_template', array(
						'quote_default' => $this->lang->line('config_quote_default'),
						'quote_pdf' => $this->lang->line('config_quote_pdf')
					),
					$this->config->item('quote_template'), array('class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_quote_default_comments_ar'), 'quote_default_comments_ar', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-5'>
					<?php echo form_textarea(array(
						'name' => 'quote_default_comments_ar',
						'dir' => 'auto',
						'id' => 'quote_default_comments_ar',
						'class' => 'form-control input-sm',
						'value' => $this->config->item('quote_default_comments_ar')));?>
				</div>
			</div>
