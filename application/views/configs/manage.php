...
<ul class="nav nav-tabs" data-tabs="tabs">
	...
	<li role="presentation">
		<a data-toggle="tab" href="#activation_tab" title="<?php echo $this->lang->line('config_activation_configuration'); ?>"><?php echo $this->lang->line('config_activation_configuration'); ?></a>
	</li>
</ul>
...
<div class="tab-content">
	...
	<div class="tab-pane" id="activation_tab">
		<?php $this->load->view("configs/activation"); ?>
	</div>
</div>
