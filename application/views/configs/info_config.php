<?php echo form_open('config/save_info/', array('id' => 'info_config_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">	
				<?php echo form_label($this->lang->line('config_company_ar'), 'company_ar', array('class' => 'control-label col-xs-2')); ?>
				<div class="col-xs-6">
					<div class="input-group">
						<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-home"></span></span>
						<?php echo form_input(array(
							...
							'value'=>$this->config->item('company_ar'))); ?>
					</div>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">	
				<?php echo form_label($this->lang->line('config_address_ar'), 'address_ar', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-6'>
					<?php echo form_textarea(array(
						'name' => 'address_ar',
						'dir' => 'auto',
						'id' => 'address_ar',
						'class' => 'form-control input-sm',
						'value'=>$this->config->item('address_ar'))); ?>
				</div>
			</div>
			
			<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('config_vat_no'), 'vat_no', array('class' => 'control-label col-xs-2 required')); ?>
			<div class='col-xs-2'>
					<?php echo form_input(array(
						'name' => 'vat_no',
						'id' => 'vat_no',
						'class' => 'form-control input-sm',
						'value' => $this->config->item('vat_no'))); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">	
				<?php echo form_label($this->lang->line('common_return_policy_ar'), 'return_policy_ar', array('class' => 'control-label col-xs-2 required')); ?>
				<div class='col-xs-6'>
					<?php echo form_textarea(array(
						...
						'id' => 'return_policy_ar',
						'class' => 'form-control input-sm required',
						'value'=>$this->config->item('return_policy_ar'))); ?>
				</div>
			</div>
