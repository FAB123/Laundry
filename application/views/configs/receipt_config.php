	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_mobile_client_secret_key'), 'config_mobile_client_secret_key', array('class' => 'control-label col-xs-2','id' => 'config_mobile_client_secret_key')); ?>
				<div class='col-xs-4'>
					<?php echo form_input(array(
						...
						'value' => str_replace("=","",base64_encode(implode(' ', array_slice(explode(' ', $this->config->item('company')), 0, 1)))))); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('receipt_template', array(
						...
						'receipt_vat' => $this->lang->line('config_receipt_vat'),
						'receipt_short' => $this->lang->line('config_receipt_short'),
						'receipt_pdf' => $this->lang->line('config_receipt_pdf'),
						'receipt_a5_pdf' => $this->lang->line('config_receipt_a5_pdf'),
						'receipt_a5_tem_pdf' => $this->lang->line('config_receipt_a5_tem_pdf'),
						'receipt_a4_tem_pdf' => $this->lang->line('config_receipt_a4_tem_pdf'),
						'receipt_pdf_no_discount' => $this->lang->line('config_receipt_pdf_no_discount')
					),
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_receipt_arabic_support'), 'receipt_arabic_support', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
						'name' => 'arabic_support',
						'value' => 'arabic_support',
						'id' => 'arabic_support',
						'checked' => $this->config->item('arabic_support'))); ?>
				</div>
			</div>

			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_receipt_show_watermark'), 'receipt_show_watermark', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
						'name' => 'receipt_show_watermark',
						'value' => 'receipt_show_watermark',
						'id' => 'receipt_show_watermark',
						'checked' => $this->config->item('receipt_show_watermark'))); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_receipt_show_payments'), 'receipt_show_payments', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
						'name' => 'receipt_show_payments',
						'value' => 'receipt_show_payments',
						'id' => 'receipt_show_payments',
						'checked' => $this->config->item('receipt_show_payments'))); ?>
				</div>
			</div>
			
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_receipt_show_amount_change'), 'receipt_show_amount_change', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
						'name' => 'receipt_show_amount_change',
						'value' => 'receipt_show_amount_change',
						'id' => 'receipt_show_amount_change',
						'checked' => $this->config->item('receipt_show_amount_change'))); ?>
				</div>
			</div>
