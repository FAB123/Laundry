	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_barcode_method'), 'barcode_method', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_dropdown('barcode_method', $barcode_methods, $this->config->item('barcode_method'), array('class' => 'form-control input-sm')); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_label_width'), 'label_width', array('class' => 'control-label col-xs-2 required')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
						'max' => '350',
						'min' => '0',
						...
						'id' => 'label_width',
						'class' => 'form-control input-sm required',
						'value'=>$this->config->item('label_width'))); ?>
				</div>
			</div>

			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_label_height'), 'label_height', array('class' => 'control-label col-xs-2 required')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
						'type' => 'number',
						'min' => 0,
						...
						'id' => 'label_height',
						'class' => 'form-control input-sm required',
						'value'=>$this->config->item('label_height'))); ?>
				</div>
			</div>
					...
					<div class="form-group form-group-sm row">
						...
						<div class='col-sm-2'>
							<?php echo form_dropdown('barcode_first_row', array(
								...
								'custom_label' => $this->lang->line('items_custom_label')
							),
						...
						<label class="control-label col-sm-1"><?php echo $this->lang->line('config_barcode_fourth_row').' '; ?></label>
						<div class='col-sm-2'>
							<?php echo form_dropdown('barcode_fourth_row', array(
								'not_show' => $this->lang->line('config_none'),
								'name' => $this->lang->line('items_name'),
								'category' => $this->lang->line('items_category'),
								'cost_price' => $this->lang->line('items_cost_price'),
							...
							$this->config->item('barcode_fourth_row'), array('class' => 'form-control input-sm')); ?>
						</div>
					</div>
				</div>
			</div>
