<?php echo form_open('config/save_general/', array('id' => 'general_config_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_spinner'), 'spinner', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_dropdown('spinner', $spinners, $this->config->item('spinner'), array('class' => 'form-control input-sm')); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_disable_add_duplicate'), 'disable_add_duplicate', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
						'name' => 'disable_add_duplicate',
						'id' => 'disable_add_duplicate',
						'value' => '1',
						'checked' => $this->config->item('disable_add_duplicate'))); ?>
				</div>
			</div>
			
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_sales_focus_on_item'), 'sales_focus_on_item', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
						'name' => 'sales_focus_on_item',
						'id' => 'sales_focus_on_item',
						'value' => '1',
						'checked' => $this->config->item('sales_focus_on_item'))); ?>
				</div>
			</div>
