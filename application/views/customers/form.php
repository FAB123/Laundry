	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="customer_basic_info">
			<fieldset>
				...
				<div class="form-group form-group-sm">   
					<?php echo form_label($this->lang->line('customers_customer_type'), 'customer_type', array('class'=>'control-label col-xs-3')); ?>
                    <div class='col-xs-8'>
                        <?php echo form_dropdown('customer_type',array(
                        'unit_price' => $this->lang->line('customers_unit_price'),
                        'wholesale_price' => $this->lang->line('customers_wholesale_price')),
                        $person_info->customer_type, array('class'=>'form-control'));?>
                    </div>
                </div>

				<div class="form-group form-group-sm">
					<?php echo form_label($this->lang->line('config_location'), 'location', array('class'=>'control-label col-xs-3')); ?>
					<div class='col-xs-8'>
						<?php echo form_dropdown('stock_location', $stock_locations, $stock_location, array('class'=>'form-control')); ?>
					</div>
				</div>
			...
			<div class="form-group form-group-sm">	
			<?php echo form_label($this->lang->line('suppliers_agency_vat_no'), 'vat_no', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<?php echo form_input(array(
					'name'=>'Vat_no',
					'id'=>'Vat_no',
					'class'=>'form-control input-sm',
					'value'=>$person_info->Vat_no)
					);?>
			</div>
		</div>
