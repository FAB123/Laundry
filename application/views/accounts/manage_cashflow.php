...
$(document).ready(function()
{
	...
	table_support.init({
		resource: '<?php echo site_url($controller_name);?>./cashflow_search',
		...
		queryParams: function() {
			return $.extend(arguments[0], {
				...
				end_date: end_date,
				location_id: <?php echo $stock_location; ?> || [""]
			});
		}
	});
});
...
<div id="title_bar" class="print_hide btn-toolbar">
	...
	<button class='btn btn-info btn-sm pull-right modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-href='<?php echo site_url($controller_name."/transfer_fund/"); ?>'
			title='<?php echo $this->lang->line('account_transfer_amount'); ?>'>
		<span class="glyphicon glyphicon-tags">&nbsp</span><?php echo $this->lang->line('account_transfer_amount'); ?>
	</button>
