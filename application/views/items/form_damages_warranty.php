...
<?php echo form_open('items/save_damages/'.$item_info->item_id, array('id'=>'item_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="inv_item_basic_info">
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('items_action'), 'action', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<?php echo form_dropdown('action', $actions, current($actions), array('onchange'=>'fill_quantity(this.value)', 'class'=>'form-control'));	?>
			</div>
		</div>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('items_quantity'), 'quantity', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-4'>
				<?php echo form_input(array(
						'name'=>'newquantity',
						'id'=>'newquantity',
	...
	<?php echo form_hidden('cost_price', $item_info->cost_price); ?>
<?php echo form_close(); ?>
