	...
	*/
	public function search($search, $filters, $rows = 0, $limit_from = 0, $sort = 'cashup_id', $order = 'asc', $count_only = FALSE)
	{
		...
		$this->db->select('
			...
			cash_up.closed_amount_credit AS closed_amount_credit,
			MAX(cash_up.closed_amount_total) AS closed_amount_total,
			cash_up.total_expanse_cash AS total_expanse_cash,
			cash_up.total_receiving_cash AS total_receiving_cash,
