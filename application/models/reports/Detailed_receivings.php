...
class Detailed_receivings extends Report
{
	...
	public function getData(array $inputs)
	{
		...
		{
			$this->db->select('name, item_number, category, quantity_purchased, serialnumber, subtotal, tax, total, discount, discount_type, item_location, receivings_items_temp.receiving_quantity');
			$this->db->from('receivings_items_temp');
