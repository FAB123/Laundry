...
require_once("Summary_receivables_payments.php");

class Receivables_payments extends Summary_receivables_payments
{
	...
	public function getData(array $inputs)
	{
		...
		$this->db->join('people AS party', 'party.person_id = sales_accounts.account_id', 'LEFT'); 
		
		if($inputs['customers'][0] != 'all')
		{
			$this->db->where_in('account_id', $inputs['customers']);
		}
