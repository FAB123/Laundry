...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 10, 2019 at 12:01 AM
...
('return_policy', 'CUSTOMER  SIGNATURE'),
('return_policy_ar', ' '),
...
('vat_no', '00000000000000'),
('version_code', 'MTU2OTE0MTYzMw=='),
...
('accounts', 1, 'home'),
('accounts_all', 1, '--'),
('accounts_Main-Store', 1, '--'),
('attributes', 1, 'office'),
('cashups', 1, 'home'),
('config', 1, 'office'),
('customers', 1, 'home'),
('customers_Main-Store', 1, '--'),
('employees', 1, 'office'),
('expenses', 1, 'home'),
('expenses_categories', 1, 'office'),
('expenses_Main-Store', 1, '--'),
('giftcards', 1, 'home'),
('home', 1, 'office'),
('items', 1, 'home'),
('items_Main-Store', 1, '--'),
...
('accounts_Main-Store', 'accounts', 1),
('attributes', 'attributes', NULL),
('cashups', 'cashups', NULL),
('config', 'config', NULL),
('customers', 'customers', NULL),
('customers_Main-Store', 'customers', 1),
('employees', 'employees', NULL),
('expenses', 'expenses', NULL),
('expenses_categories', 'expenses_categories', NULL),
('expenses_Main-Store', 'expenses', 1),
('giftcards', 'giftcards', NULL),
('home', 'home', NULL),
('items', 'items', NULL),
('items_Main-Store', 'items', 1),
('item_kits', 'item_kits', NULL),
('office', 'office', NULL),
('receivings', 'receivings', NULL),
('receivings_Main-Store', 'receivings', 1),
...
('reports_receivable', 'reports', NULL),
...
('o3ojfkfjhtp176f72o7jba0356tgp0hl', '::1', 1570665661, 0x5f5f63695f6c6173745f726567656e65726174657c693a313537303636353435313b706572736f6e5f69647c733a313a2231223b6d656e755f67726f75707c733a363a226f6666696365223b73616c655f69647c693a2d313b73616c65735f696e766f6963655f6e756d6265725f656e61626c65647c623a303b);
